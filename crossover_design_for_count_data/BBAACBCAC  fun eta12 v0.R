...
sim.BBA3<-function(seq,dataType){
...
res31<-do.call(rbind, lapply(c(25,50,150,250), sim.BBA3, dataType="Poisson")) 
write_xlsx(data.frame(res31),path = paste0(Path,"/BBA3_funPo_rho=",cor_par,"_",substr(Sys.Date(),6,10),".xlsx"))

res32<-do.call(rbind, lapply(c(25,50,150,250), sim.BBA3, dataType="Weibull")) 
write_xlsx(data.frame(res32),path = paste0(Path,"/BBA3_funWei_rho=",cor_par,"_",substr(Sys.Date(),6,10),".xlsx"))
